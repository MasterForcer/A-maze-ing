...
public class RulesApi {
    ...
    public String get() throws ApiException {
        ApiResponse<String> resp = getWithHttpInfo();
        return resp.getData();
    }
    ...
    /**
     * 📜 Learn all the rules for this evening. (asynchronously)
     * Spoiler alert: rule #1 is to have fun!
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAsync(final ApiCallback<String> callback) throws ApiException {
