...
public class MazesApi {
    ...
    public com.squareup.okhttp.Call allCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/api/mazes/all";
     ...
     */
    public List<MazeInfo> all() throws ApiException {
        ApiResponse<List<MazeInfo>> resp = allWithHttpInfo();
        return resp.getData();
    }
     ...
     * 📜 All the mazes that exist in the game.
     * Even though you can only play a maze once, this method will return all the mazes. This is not lazyness from the server side, this is to make it slightly more \&quot;interesting\&quot;, because you need to keep track of the mazes you have already played on your implementation.
     * @return ApiResponse&lt;List&lt;MazeInfo&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<List<MazeInfo>> allWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = allValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<List<MazeInfo>>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * 📜 All the mazes that exist in the game. (asynchronously)
     * Even though you can only play a maze once, this method will return all the mazes. This is not lazyness from the server side, this is to make it slightly more \&quot;interesting\&quot;, because you need to keep track of the mazes you have already played on your implementation.
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call allAsync(final ApiCallback<List<MazeInfo>> callback) throws ApiException {
